...
function calculator() {
    ...
    let divisionN = document.querySelector('.division');
    let multiplicationN = document.querySelector('.multiplication');

    plusS.addEventListener('click', () => {
        inOne = Number(document.querySelector('.inOne').value);
        inTwo = Number(document.querySelector('.inTwo').value);
        out = inOne + inTwo;
    ...
    divisionN.addEventListener('click', () => {
        inOne = Number(document.querySelector('.inOne').value);
        inTwo = Number(document.querySelector('.inTwo').value);
        out = inOne / inTwo;
        document.querySelector('.out').textContent = out;
    });
    multiplicationN.addEventListener('click', () => {
        inOne = Number(document.querySelector('.inOne').value);
        inTwo = Number(document.querySelector('.inTwo').value);
        out = inOne * inTwo;
        document.querySelector('.out').textContent = out;
